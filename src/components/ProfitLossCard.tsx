...
const ProfitLossCard: React.FC<ProfitLossCardProps> = React.memo(
  ({
    totalProfitLoss,
    ...
    useEffect(() => {
      console.log("ProfitLossCard mounted"); // Log a message when the component mounts
    }, []);
    return (
  ...
  (prevProps, nextProps) => {
    return (
      prevProps.totalProfitLoss === nextProps.totalProfitLoss &&
      prevProps.totalProfitLossPercentage ===
        nextProps.totalProfitLossPercentage &&
      prevProps.totalInvested === nextProps.totalInvested &&
      prevProps.openPositions === nextProps.openPositions
    );
  }
);
